  ...
  return (
    <nav>
      {isAboveMediumScreens ? (
        <div className="flex items-center justify-between w-[1440px] bg-background-primary border-b-[1px] py-[28px] px-[165px] h-[82px]">
            <div className= "flex items-center justify-between w-full">
              <div className="w-[145px] h-[38.33px]">
                <img src={icons.logoblack} alt="logo" />
              </div>
              <div className="flex items-center justify-between w-[348px] h-[10px] gap-[60px]">
                <Navlink label="Home" to="/" />
                <Navlink label="Shop" to="/Shop" />
                <Navlink label="About" to="/About" />
                <Navlink label="Contact" to="/Contact" />
              </div>
              <div className="flex items-center justify-between w-[152px] h-[20px] gap-[24px]">
        ...
        <div className="flex items-center justify-between w-[430px] bg-background-primary border-b-[1px] p-[20px] h-[82px]">
            <div className="flex items-center justify-between w-full">
              <div>
